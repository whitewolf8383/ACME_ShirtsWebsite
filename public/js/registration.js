/* This script listens for a click event, checks to ensure
/* values are entered and valid in each entery box, then 
/* stores the data in session storage. If an entry is bad,
/* it will display an error on the screen. 
*/ 
